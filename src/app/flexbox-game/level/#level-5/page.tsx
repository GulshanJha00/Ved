...
//             <Image src={Station} alt="Charging Station" width={160} height={160} className="chargers-1 inline-block absolute  left-40 top-[40rem]"/>
//             <Image src={Station} alt="Charging Station" width={160} height={160} className="chargers-2 inline-block absolute max-xl:top-[40rem]"/>
//           </div>

//           {/* Robot Image with User-defined CSS */}
//           <div className="px-3 flex animated min-h-screen max-lg:h-[40rem] items-start" style={{ alignItems: `${input}` }} >
//             <Image
...
const Page = () => {
  ...
  return (
    <>
      <div className="min-h-screen grid grid-cols-5 text-white max-w-[1150px]:grid-cols-1">
        {/* Left Panel */}
        <div className="text-4xl col-span-2 bg-cyan-800 border-r-2 border-white max-w-[1150px]:border-none max-w-[1150px]:col-span-5">
          <div className="border-b-2 border-white relative p-4 flex">
            <h1 className="rowdies-regular w-40">Ved Flex</h1>
            <span className="absolute right-4 space-x-2 flex">
              <Link href={`./level-${level - 1}`} className="inline-block"><IoMdArrowDropleftCircle /></Link>
          ...
          <div className="max-xl:text-[0.9rem] text-[1rem] leading-7 mx-2 my-4 font-sans">
            <span className="text-2xl rowdies-regular">Understanding <span className="bg-gray-100/40">align-items</span> and How It Works:</span>
            <br />
            The align-items property is a powerful CSS feature that controls how flex items are positioned along the cross axis of a flex container. This property is especially useful for aligning items when they have different heights or when the container has more space than needed. <br/>
            <span className="bg-gray-100/40">flex-start</span> – Items are aligned at the start of the cross axis. <br />
            <span className="bg-gray-100/40">flex-end</span> – Items are aligned at the end of the cross axis. <br />
            <span className="bg-gray-100/40">center</span> – Items are centered along the cross axis. <br />
            <span className="bg-gray-100/40">baseline</span> – Items are aligned based on their text baseline. <br />
        ...
        {/* Right Panel */}
        <div className="text-4xl col-span-3 min-h-screen flex flex-col items-center justify-center max-w-[1150px]:col-span-5">
          <div className="relative z-0 flex justify-center">
            <Image src={Station} alt="Charging Station" width={160} height={160} className="chargers-1 inline-block"/>
            <Image src={Station} alt="Charging Station" width={160} height={160} className="chargers-2 inline-block"/>
          </div>
          <div className="px-3 flex animated min-h-screen items-start max-w-[1150px]:items-center" style={{ alignItems: `${input}` }}>
            <Image src={isCharging ? Charge : DisCharge} alt="Robot Status" width={144} height={144} className="z-20 mr-4" />
            <Image src={isCharging ? Charge : DisCharge} alt="Robot Status" width={144} height={144} className="z-20 mr-4" />
          </div>
        </div>
      </div>
