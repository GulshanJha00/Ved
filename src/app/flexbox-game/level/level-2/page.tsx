    ...
    <>
      <div className="h-screen grid grid-cols-5 text-white">
        ...
        <div className="text-4xl col-span-3 testClass">
          {/* Charging Station */}
          <div className="absolute right-[19.5%] z-0">
            <Image src={Station} alt="Charging Station" width={160} height={160} className="inline-block" />
            <Image src={Station} alt="Charging Station" width={160} height={160} className="inline-block" />
          </div>

          {/* Robot Image with User-defined CSS */}
          <div className="px-3 flex animated z-30" style={{ justifyContent: `${input}` }}>
            <Image
